# Consider the problem of pricing a kind of basket call option with two stocks:
#S1(t) = 100e(r−σ2 1/2)t+σ1B1(t), S2(t) = 100e(r−σ2 2/2)t+σ2[0.6B1(t)+0.8B2(t)], discounted payoﬀ = max([S1(T/2) + S1(T) + S2(T/2) + S2(T)]/4−K,0)e−rT, r = 1%, σ1 = 40% σ2 = 60%, T = 1/2 year, K = $100. Here B1 and B2 are independent Brownian motions. Estimate the price of the basket call option with an error tolerance of $0.05.
...
price<-mean(discpayoff)
price
#The price of the basket call option with an error tolerance of 0.05 is $10.13221 and the optimal sample size is 996400.3
